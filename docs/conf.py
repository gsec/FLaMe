...
sys.path.insert(0, os.path.abspath('../flame/flame'))

# -- General configuration ------------------------------------------------

# MOCKS FOR readthedocs compilation

MOCK_MODULES = ['matplotlib.cm']
...
latex_documents = [
    (master_doc, 'FLaMe.tex', u'FLaMe Documentation',
